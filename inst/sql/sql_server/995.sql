...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4175026,4173614,4190931,4161577)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4175026,4173614,4190931,4161577)
  and c.invalid_reason is null
...
WHERE C.value_as_concept_id in (36310827,36309245,36309661)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (36310675,36308530,36307777,36310111)
-- End Measurement Criteria
