...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1177227,1177367,437525)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1177227,1177367,437525)
  and c.invalid_reason is null
...
WHERE (C.value_as_number >= 25.0000 and C.value_as_number <= 29.9000)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (1177227,1177367)
-- End Measurement Criteria
