...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4172043,4161578)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4172043,4161578)
  and c.invalid_reason is null
...
WHERE C.value_as_concept_id in (36309245)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 50.0000 and C.value_as_number <= 60.0000)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (36309822,36311005)
-- End Measurement Criteria
