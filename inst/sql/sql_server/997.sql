...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4162590,4161579,4174241,4174251,4173456)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4162590,4161579,4174241,4174251,4173456)
  and c.invalid_reason is null
...
WHERE C.value_as_concept_id in (36308652,36308589,45880868)
-- End Measurement Criteria
...
WHERE C.value_as_concept_id in (36309699,36310627,36309106,36310215,45880868)
-- End Measurement Criteria
